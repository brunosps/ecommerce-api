...
RSpec.describe "Admin V1 System Requirements as :admin", type: :request do
  ...
  context "GET /system_requirements" do
    ...
    it "returns all System Requirements" do
      ...
      expect(body_json["system_requirements"]).to contain_exactly *system_requirements.as_json(only: %i(id name memory operational_system processor storage video_board))
    end
